...
describe('categoryService', function () {
  ...
  xit('should add category when does not have exist category use post',function(){
    var category={name: '测试'};
    $httpBackend.expectGET('/api/categories').respond(200,categories);
    $httpBackend.expectPOST('/api/categories',{categories:categories}).respond(200, categories);
    categoryService.addCategory(category,function(data){
